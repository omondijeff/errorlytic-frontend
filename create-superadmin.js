...
async function createSuperAdmin() {
  try {
    // Connect to MongoDB
    const mongoUri = process.env.MONGODB_URI || 'mongodb://admin:password123@localhost:27017/vagnosis_saas?authSource=admin';
    ...
    console.log('');
    console.log('🚀 You can now use these credentials to log in as super admin!');
