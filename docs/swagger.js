...
const options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'VAGnosis SaaS API',
      version: '1.0.0',
      description: 'Professional Automotive Diagnostic and Quotation System for VAG Group Vehicles',
      contact: {
        name: 'VAGnosis Support',
        email: 'support@vagnosis.com',
        url: 'https://vagnosis.com'
      },
      license: {
        name: 'MIT',
    ...
    components: {
      ...
      schemas: {
          ...
          properties: {
            ...
            summary: {
              ...
              properties: {
                overview: {
                  type: 'string',
                  example: 'Found 1 critical error code requiring immediate attention'
                },
                severity: {
                  type: 'string',
            ...
            steps: {
              ...
              items: {
                ...
                properties: {
                  ...
                  detail: {
                    type: 'string',
                    example: 'Inspect spark plugs and ignition coils for damage'
                  },
                  type: {
                    type: 'string',
        ...
        Quotation: {
          type: 'object',
          required: ['analysisId', 'currency', 'labor', 'parts', 'taxPct', 'markupPct'],
          properties: {
            _id: {
              type: 'string',
...
module.exports = {
  ...
  swaggerOptions: {
    ...
    `,
    customSiteTitle: 'VAGnosis SaaS API Documentation',
